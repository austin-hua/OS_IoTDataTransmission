...
### Execution
After you are finished compiling, run these shell files.
...
### Post-Execution
<em>clean</em>
This shell file will remove all files generated by the program and will call <en>removeModules.sh</en> to remove loaded modules.
<em>removeModules.sh</em>
